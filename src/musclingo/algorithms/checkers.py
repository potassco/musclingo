...
def check_maximal_satisfiable(
	ctl: clingo.Control, mss: Sequence[int], mcs: Sequence[int]
) -> None:
	...
	for x in mcs:
		...
		assert ans.unsatisfiable, (
			"The MSS is not maximal: adding a corrected literal stays satisfiable..."
		)
